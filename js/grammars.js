 var rawGrammars = {
    ...
    "continueConvo": ["Also, have I mentioned that", "Just to let you know,", "Before I forget,", "By the way,", "Also,", ],
	...
	"#noun# in the #genName# #location#s", "grooming my #bodyPart#s", "spitting out #adjectives# hairballs", "#noun# with my best friend, #name# the #animal#"  ],
    ...
    "occupationConvo":["I am #occupation#", "my friends all know me as #occupation#","they call me '#occupation#'","I am very #animal#-like in my behavior"],
	"occupation": [
	...
	"food":[ "hamburger", "taco","sushi", "pasta","cake","kebab","popsickle","cookie", "brownie","kibble","cupcake","peanut","curry"],
	...
	"adjectives": ["fluffy","handsome","sexy","hot","lovely","beautiful","breath-taking","gorgeous","cool", "pretty",],
